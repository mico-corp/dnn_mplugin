...
listDark *read_cfg(char *filename);
...
local_layer parse_local(listDark *options, size_params params)
{
...
layer parse_deconvolutional(listDark *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
convolutional_layer parse_convolutional(listDark *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(listDark *options, size_params params)
{
...
layer parse_rnn(listDark *options, size_params params)
{
...
layer parse_gru(listDark *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(listDark *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_connected(listDark *options, size_params params)
{
    int output = option_find_int(options, "output",1);
	const char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
softmax_layer parse_softmax(listDark *options, size_params params)
{
    int groups = option_find_int_quiet(options, "groups",1);
...
layer parse_yolo(listDark *options, size_params params)
{
...
layer parse_region(listDark *options, size_params params)
{
...
detection_layer parse_detection(listDark *options, size_params params)
{
...
cost_layer parse_cost(listDark *options, size_params params)
{
...
crop_layer parse_crop(listDark *options, size_params params)
{
...
layer parse_reorg(listDark *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
maxpool_layer parse_maxpool(listDark *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(listDark *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(listDark *options, size_params params)
{
...
layer parse_normalization(listDark *options, size_params params)
{
...
layer parse_batchnorm(listDark *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(listDark *options, size_params params, network *net)
{
...
layer parse_l2norm(listDark *options, size_params params)
{
...
layer parse_logistic(listDark *options, size_params params)
{
...
layer parse_activation(listDark *options, size_params params)
{
    const char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_upsample(listDark *options, size_params params, network *net)
{
...
route_layer parse_route(listDark *options, size_params params, network *net)
{
...
void parse_net_options(listDark *options, network *net)
{
...
{
    listDark *sections = read_cfg(filename);
    ...
    if(workspace_size){
        ...
        if(gpu_index >= 0){
			...
			net->workspace_gpu = cl_make_array(0, (workspace_size - 1) / sizeof(float) + 1);
        }else {
    ...
    while((line=fgetl(file)) != 0){
        ...
        switch(line[0]){
            case '[':
                ...
                list_insert(options, (char*)current);
