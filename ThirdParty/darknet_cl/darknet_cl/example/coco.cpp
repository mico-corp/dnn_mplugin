...
void validate_coco(char *cfg, char *weights)
{
    ...
    //listDark *plist = get_paths("/home/pjreddie/data/people-art/test.txt");
    //listDark *plist = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
...
void run_coco(int argc, char **argv)
{
	...
	char** coco_classes_name = const_cast<char**>(coco_classes);
    if(0==strcmp(argv[2], "test")) test_coco(cfg, weights, filename, thresh);
    else if(0==strcmp(argv[2], "train")) train_coco(cfg, weights);
    else if(0==strcmp(argv[2], "valid")) validate_coco(cfg, weights);
    else if(0==strcmp(argv[2], "recall")) validate_coco_recall(cfg, weights);
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, coco_classes_name, 80, frame_skip, prefix, avg, .5, 0,0,0,0);
}
